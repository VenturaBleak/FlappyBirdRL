...
parser.add_argument("--initial_exploration", type=float, default=0.16, help="Initial exploration rate.")
parser.add_argument("--final_exploration", type=float, default=0.007, help="Final exploration rate.")
...
parser.add_argument("--buffer_size", type=int, default=0.10, help="Size of the replay buffer as a fraction of the total number of time steps.")
parser.add_argument("--batch_size", type=int, default=32, help="Number of transitions to sample from the replay buffer at each learning step.")
parser.add_argument("--total_timesteps", type=int, default=8000000, help="Total number of time steps.")
...
# Save the agent
model.save("dqn_flappybird_1")
del model  # delete trained model to demonstrate loading

# Load the trained agent
model = DQN.load("dqn_flappybird_1", env=env)
